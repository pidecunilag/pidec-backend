...
export const VERIFICATION_LIMITS = {
  ...
  REDIS_BUFFER_TTL_S: 180, // 3 minutes — enough for the silent finalization pass
...
export const VERIFICATION_DOC_MIME_TYPES = ['application/pdf', 'image/png', 'image/jpeg'] as const;
